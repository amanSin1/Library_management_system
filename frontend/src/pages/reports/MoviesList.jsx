...
export default function MoviesList() {
  ...
  useEffect(() => { api.get('/reports/movies').then(r => setData(r.data)) }, [])
  ...
  return (
    <div className="container">
      ...
      <div className="card">
        <table>
          <thead>
            <tr><th>Serial No</th><th>Name</th><th>Author/Director</th><th>Category</th><th>Status</th><th>Cost</th><th>Procurement Date</th></tr>
          </thead>
          <tbody>
            {data.map(r => (
              <tr key={r.serial_no}>
